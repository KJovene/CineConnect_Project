  ...
  return (
    <>
      ...
      <div className="relative w-full h-[60vh] lg:h-[65vh]">
        ...
        <div className="absolute bottom-0 left-0 right-0 px-6 lg:px-12 pb-10 max-w-6xl mx-auto">
          ...
          <div className="flex flex-wrap items-center gap-x-6 gap-y-3 text-sm lg:text-base font-medium text-white">
            ...
            {roundedAverageRating !== null && (
              <div
                className="lg:ml-auto flex items-center gap-2 backdrop-blur-md px-3 py-1 rounded-full"
                style={{
