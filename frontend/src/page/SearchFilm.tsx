            ...
            <div className="mb-16">
              ...
              {isLoading && (
                <div className="text-center py-12">
                  ...
                  <p className="text-sm text-neutral-400">Recherche en cours...</p>
                </div>
              )}
              ...
              {!isLoading && results.length === 0 && !error && (
                <div className="text-center py-12">
                  ...
                  <p className="text-neutral-400 text-lg">
                    Aucun résultat pour <span className="text-white font-medium">"{searchQuery}"</span>
                  </p>
                </div>
              )}
                ...
                <>
                  <div className="mb-4 px-2">
                    <p className="text-sm text-neutral-400">
                      {data?.totalResults ? `${data.totalResults} résultats trouvés` : `${results.length} résultats`}
                    </p>
                  </div>
